...
\def\Btodsttaunu  {\ensuremath{\Bbar \to D^{(\ast)} \tau^- \bar{\nu}_\tau}\xspace}
\def\Btodstdlnu {\ensuremath{B \to \Dstar(D) \ell \nu}\xspace}
\def\Btorholnu  {\ensuremath{\Bbar \to \rhoz \ellm \barnuell}\xspace}
...
%\newcommand {\bpipilnu} {\overline{B} \to \pi \pi \ellm \barnuell}
...
\newcommand {\bdstlnu} {\overline{B} \to D^\ast \ell^- \overline{\nu}_\ell}
\newcommand {\bzdstlnu} {\Bz \to D^{\ast +} \ell^- \overline{\nu}_\ell}
...
\newcommand {\bvlnu} {\overline{B} \to V \ell^- \overline{\nu}_\ell}
\newcommand {\bpipilnu} {\Bm \to \pip \pim \ell^- \overline{\nu}_\ell}
\newcommand {\bmrlnu} {B^- \to \rhoz \ell^- \overline{\nu}_\ell}
...
\def\mpipi       {\ensuremath{m_{\pi\pi}}\xspace}
\def\gevsq       {\ensuremath{{\rm GeV}^2}\xspace}
