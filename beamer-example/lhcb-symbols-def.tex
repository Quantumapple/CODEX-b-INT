%%% $Id: lhcb-symbols-def.tex 90556 2016-04-11 17:30:42Z bdey $
%%% ======================================================================
...
\def\LK        {\ensuremath{\Lb\to K^-p\;\mu^-\mu^+}\xspace}
\def\LamK      {\ensuremath{\Lb \to K^-p\;\mu^-\mu^+}\xspace}
\def\Lpi       {\ensuremath{\Lbbar\to pi^-p\;\mu^-\mu^+}\xspace}
\def\LbarK     {\ensuremath{\Lbbar \to K^+ \bar{p}\mu^+\mu^-}\xspace}
\def\Lbarpi    {\ensuremath{\Lbbar \to \pi^+\bar{p}\mu^+\mu^-}\xspace}
\def\LKJ       {\ensuremath{\Lb \to K^- p J/\psi}\xspace}
\def\LKccbar   {\ensuremath{\Lb\to K^- p \;c\overline{c}}\xspace} 
\def\BsKKmm    {\ensuremath{B_s\to KK\mu^-\mu^+}\xspace}
\def\BdKpimm   {\ensuremath{B_d\to K\pi\mu^-\mu^+}\xspace}
...
\def\ACP      {{\ensuremath{a_{\CP}^{T_{\text{odd}}}}}\xspace}
